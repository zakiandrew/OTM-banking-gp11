...
--
-- Host: localhost:3307
-- Generation Time: Apr 06, 2017 at 04:40 AM
...
(98683, 'WB6357', 'Al', 'Pacino', 'Goldy', 'old', 'gold', 'ACTIVE', 'New York', 'MICHIGAN', 'USA', '2013-02-09', '2017-04-06 04:30:16');
...
INSERT INTO `employees` (`empid`, `employee_name`, `loginid`, `password`, `emailid`, `contactno`, `createdat`, `last_login`, `role`) VALUES
...
(313788, 'Rick', '3535355', '3636', 'jyothi@yahoo.com', '95425422424', '2013-01-02', '0000-00-00 00:00:00', 'teller'),
...
(21, '', '', '2016-12-21 02:25:02', '98683', '98680');
...
CREATE TABLE `organizations` (
  ...
  `Financials` tinyint(1) NOT NULL,
  `CBS` tinyint(1) NOT NULL,
...
INSERT INTO `organizations` (`ID`, `Name`, `Username`, `Email`, `Password`, `Payroll`, `Financials`, `CBS`, `ProfileImage`, `LastLogin`) VALUES
(7, 'Valley View University', 'henry', 'henryiller@gmail.com', '63a9f0ea7bb98050796b649e85481845', 1, 0, 0, '', '2016-12-14 08:51:31'),
(5, 'Natty and co', 'natty', 'holylamb.larsey@hotmail.com', '2e3b623e1a07a6150a744a7b74c18e69', 1, 0, 0, '', '0000-00-00 00:00:00'),
(3, 'David Financials', 'David', 'daviddowuona9.dd@gmail.com', '1a1dc91c907325c69271ddf0c944bc72', 0, 0, 0, '', '0000-00-00 00:00:00'),
(8, 'otm banking', 'admin', 'admin@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 0, 1, 1, '', '2017-04-06 04:16:02');
...
--
ALTER TABLE `mail`
  MODIFY `mailid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
...
--
ALTER TABLE `transactions`
  MODIFY `transactionid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;COMMIT;
